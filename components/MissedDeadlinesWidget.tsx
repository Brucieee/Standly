...
export const MissedDeadlinesWidget: React.FC<MissedDeadlinesWidgetProps> = ({ users, deadlines, currentUserId }) => {
      ...
      {deadlines.length === 0 ? (
        ...
        <div className="space-y-4">
          {deadlines.map(deadline => {
            ...
            return (
              <div key={`deadline-${deadline.id}`} className="relative bg-slate-200 rounded-2xl p-4 flex items-start gap-3 shadow-neo-sm-inner">
                {isCreator && (
